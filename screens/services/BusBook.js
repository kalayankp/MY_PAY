...
const BusBook = () => {
  ...
  return (
    <View style={{margin:20,justifyContent:'center'}}>
      ...
      <Text style={{ textAlign: 'center', fontWeight: "bold", fontSize: 25, color: "black" }}>BUS BOOKING  </Text>
      <Image source={require('../../assests/icons/images/bus.png')} style={{ width: 42, height: 38,}} />
      </View>   
...
<View style={{ marginTop: 20,flexDirection:'row',justifyContent:'center',marginLeft:12 }}>
      <View style={{borderColor:'black',borderWidth:1,borderTopWidth:1,width:'98%',margin:10,marginLeft:-5}}>
     ...
     <View style={{ marginTop: 10,flexDirection:'row',justifyContent:'center',marginLeft:12}}>
      ...
      <TouchableOpacity style={{ backgroundColor: "#3f46c8", height: 45, width: 300, borderRadius: 8, marginTop: 50, justifyContent: "center", margin: 20 }} onPress={Proced} >
        <Text style={{ color: '#ffffff', textAlign: "center",fontSize:20 }}>Search Bus</Text>
      </TouchableOpacity>
    </View>
  )
}

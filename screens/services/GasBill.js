...
import {View,Text,TextInput,TouchableOpacity,StyleSheet} from 'react-native'
  ...
  const data = [
    { label: 'Indian Gas', value: '1' },
    { label: 'HP Gas', value: '2' },
    { label: 'Bharat Gas', value: '3' },
...
const GasBill=({ navigation, route })=>{
  ...
  return(
    <View style={{padding:20,marginTop:'10%',}}>
      <Text style={{fontSize:28,fontWeight:'bold',textAlign:'center'}}>Book LPG Gas Cylinder</Text>
   <View style={{marginTop:'20%'}}>
      <Text style={{fontSize:20,padding:8,fontWeight:'bold',color:'black',marginTop:20}}> Consumer No / Mobile No </ Text>
      ...
      <View style={{flexDirection:'row',marginTop:10,borderBottomWidth:2,borderColor:'grey'}}>
        ...
        labelField="label"
        // valueField="value"
        placeholder="Select Gas Partner"
      ...
      />
       <Text style={{fontSize:20,padding:8,fontWeight:'bold',color:'grey',marginTop:-32,}}> {value} </ Text>
       </View>
